...
def compare_images(
    ...
    system_prompt = (
        ...
        "Pay special attention to the logo, the text, the headlights, tail lights, wheels, mirrors, grill, bumpers, contours, etc. "
        "Pay attention to the overall clarity, shape, color and perspective of the car. "
