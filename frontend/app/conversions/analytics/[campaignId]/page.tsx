    ...
    return (
      <ProtectedRoute>
        <div className="flex min-h-screen flex-col items-center justify-center">
          ...
          <Button onClick={() => router.push("/conversions")} className="mt-4">
  ...
  return (
    <ProtectedRoute>
      <div className="flex min-h-screen flex-col">
        <div className="flex h-20 items-center px-6 md:px-8 border-b">
          <div className="flex items-center gap-4 w-full">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                View all conversations with leads who converted
              </p>
            </div>
            <Button
              variant="outline"
        ...
        <main className="flex-1 space-y-6 px-6 md:px-8 pb-8 w-full pt-6">
          <Card>
            <CardHeader>
