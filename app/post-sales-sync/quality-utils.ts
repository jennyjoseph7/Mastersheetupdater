...
export function getOutputColumnsForDealer(dealerKey: string): OutputColumn[] {
  const schemas: Record<string, OutputColumn[]> = {
    ...
    anant_wa: [
      { header: 'Lead_ID+A1', key: 'lead_id' }, { header: 'Full_Name', key: 'full_name' },
      { header: 'Phone', key: 'phone_number' }, { header: 'City', key: 'city' },
      { header: 'Pincode', key: 'pincode' }, { header: 'Language', key: 'language' },
      { header: 'Cohort', key: 'cohort' }, { header: 'Campaign_ID', key: 'campaign_id' },
      { header: 'Session_ID', key: 'session_id' },
      { header: 'Call Triggered', key: 'call_triggered' },
      { header: 'STATUS', key: 'session_status' }, { header: 'SUMMARY', key: 'summary' },
      { header: 'DISPOSITION_DETAILS', key: 'disposition_detail' }, { header: 'CALL_DATE', key: 'call_date' },
      { header: 'SENTIMENT', key: 'sentiment_score' }, { header: 'DURATION', key: 'duration' },
      { header: 'ORIGIN', key: 'origin' }, { header: 'LEAD_TIMELINE', key: 'lead_timeline' },
