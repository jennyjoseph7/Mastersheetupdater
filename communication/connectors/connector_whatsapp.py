...
def post_contact_status(*args, **data):
    ...
    with get_pg_connector() as pg:
        ...
        if incoming_status not in {"initiated", "queued", "attempted"}:
            ...
            call_next_campaign_workflow_task(payload.get("campaign_id"),payload.get("campaign_type"),payload.get("lead_id"),payload.get("channel"),data.get(channel_identifier),incoming_status,pg=pg,skip_workflow=data.get("skip_workflow", False))
