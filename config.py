...
AUTOCRM_VOICE_INBOUND_SERVICE_NAME_2 = os.environ.get("AUTOCRM_VOICE_INBOUND_SERVICE_NAME_2", "autocrm-voice-inbound-2")
AUTOCRM_VOICE_INBOUND_SERVICE_NAME_3 = os.environ.get("AUTOCRM_VOICE_INBOUND_SERVICE_NAME_3", "autocrm-voice-inbound-3")
AUTOCRM_VOICE_INBOUND_SERVICE_NAME_4 = os.environ.get("AUTOCRM_VOICE_INBOUND_SERVICE_NAME_4", "autocrm-voice-inbound-4")
AUTOCRM_VOICE_INBOUND_SERVICE_NAME_5 = os.environ.get("AUTOCRM_VOICE_INBOUND_SERVICE_NAME_5", "autocrm-voice-inbound-5")
