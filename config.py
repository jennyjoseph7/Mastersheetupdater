...
AUTOCRM_CALL_CONNECTED_UNITS = os.environ.get("AUTOCRM_CALL_CONNECTED_UNITS", "count")
AUTOCRM_CALL_COMPLETED_PRICE = os.environ.get("AUTOCRM_CALL_COMPLETED_PRICE", 10/60.0)
AUTOCRM_CALL_COMPLETED_UNITS = os.environ.get("AUTOCRM_CALL_COMPLETED_UNITS", "seconds")
AUTOCRM_MESSAGE_DELIVERED_PRICE = os.environ.get("AUTOCRM_MESSAGE_DELIVERED_PRICE", 0.75)
AUTOCRM_MESSAGE_DELIVERED_UNITS = os.environ.get("AUTOCRM_MESSAGE_DELIVERED_UNITS", "count")
AUTOCRM_RESPONSE_PROVIDED_PRICE = os.environ.get("AUTOCRM_RESPONSE_PROVIDED_PRICE", 1)
AUTOCRM_RESPONSE_PROVIDED_UNITS = os.environ.get("AUTOCRM_RESPONSE_PROVIDED_UNITS", "count")
