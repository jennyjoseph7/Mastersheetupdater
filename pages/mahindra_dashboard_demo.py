...
st.set_page_config(page_title="Mahindra Agentic CX Demo", layout="wide")
st.markdown("## 🤖 **Mahindra Agentic CX Demo**")
st.write("This demo shows how DaveAI's platform converts a cold visitor into a potential customer.")
st.sidebar.image("https://banner2.cleanpng.com/lnd/20250107/zv/9f7736f387374af567bc3cb51a88c4.webp", width=200)
...
if run_agent:
    segment_classifier_agent_call = [{
            ...
            "kwargs": {
                "source": input_data,
                "brand_url" : "https://auto.mahindra.com/suv/xuv3xo/X3XO.html"
            },
            "args": (None)
    }]
